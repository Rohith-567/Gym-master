...
const Hero = () => {
  ...
  <div className="flex-1 flex flex-col justify-between px-2 py-6 md:px-4 capitalize">
     ...
     <h1 className="text-2xl md:text-6xl font-bold capitalize md:leading-snug md:my-6">Shape your body,<br />Transform your <span className="text-orange-400">Life</span></h1>
          ...
          <p className="md:text-xl md:leading-normal mt-4">Welcome to our fitness community, where your journey
             to a healthier, stronger, and more vibrant you begins. At Gym Master, we believe that fitness
              is not just about working out; it's a way of life. Our mission is to inspire and empower individuals 
            to embrace a lifestyle of physical activity, balanced nutrition, and mental well-being.<span></span>
               <img src="/img/curve-arrow.png" alt="arrow" width={100} height={100} className="rotate-90" /></p>
