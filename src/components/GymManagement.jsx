...
const GymManagement = () => {
  return (
    <div className="flex flex-col md:flex-row justify-between px-2 md:px-4 py-2 my-8 capitalize">
     ...
     <p className="md:text-xl md:leading-normal mt-4">With the power of artificial intelligence, Gym Master offers personalized workout plans, real-time performance tracking, and adaptive training programs tailored specifically to your needs.</p>
