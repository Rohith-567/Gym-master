...
const Facilities = () => {
  return (
    <div className="flex flex-col md:flex-row justify-between my-8 px-2 md:px-4 py-6 capitalize">
      ...
      <p className="md:text-xl md:leading-normal mt-4"> Our gym is equipped with the latest in high-quality
         fitness equipment, including a wide variety of cardio machines, strength training stations, and free weights to suit all fitness levels and preferences. We also provide
         spacious workout areas, dedicated spaces for group classes, and a serene yoga and stretching zone.</p>
