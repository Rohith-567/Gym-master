  ...
  return (
    <div className="flex flex-col md:flex-row justify-between px-2 md:px-4 py-2 my-8 capitalize">
     ...
     {imageData.map((data) => (
      ...
      <p className="md:text-xl md:leading-normal mt-4">Our facilities are equipped with state-of-the-art surveillance systems and controlled access points to monitor and manage entry. </p>
